  ...
  describe("LogstashFormatter", function() {
    ...
    return describe("when created with some consts", function() {
      ...
      it("formats an entry without meta", function() {
        ...
        formatted = testedFormatter.format(entry);
        return formatted.should.equal('{ ' + '"timestamp": "1970-01-01T00:00:00.000Z", ' + '"logger": "test", ' + '"level": "good", ' + '"message": "hello, file!", ' + '"test_author": "Maciej"' + ' }\n');
      });
      return it("formats an entry with meta", function() {
        ...
        formatted = testedFormatter.format(entry);
        return formatted.should.equal('{ ' + '"timestamp": "1970-01-01T00:00:00.000Z", ' + '"logger": "test", ' + '"level": "good", ' + '"message": "hello, file!", ' + '"test_author": "Maciej", ' + '"test_number": 1' + ' }\n');
      });
    });
  });
