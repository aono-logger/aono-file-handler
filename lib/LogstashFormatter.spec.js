  ...
  describe("LogstashFormatter", function() {
    ...
    describe("when created without any consts", function() {
      ...
      it("formats an entry without meta", function() {
        ...
        return formatted.should.equal('{ ' + '"timestamp": 0, ' + '"logger": "test", ' + '"level": "good", ' + '"message": "hello, file!"' + ' }\n');
      });
      it("formats an entry with meta", function() {
        ...
        formatted = testedFormatter.format(entry);
        return formatted.should.equal('{ ' + '"timestamp": 0, ' + '"logger": "test", ' + '"level": "good", ' + '"message": "hello, file!", ' + '"»number": 1' + ' }\n');
      });
      return it("formats an entry containing utf character", function() {
        ...
        formatted = testedFormatter.format(entry);
        return formatted.should.equal('{ ' + '"timestamp": 10, ' + '"logger": "test", ' + '"level": "good", ' + '"message": "☃"' + ' }\n');
      });
    });
    return describe("when created with some consts", function() {
      ...
      it("formats an entry without meta", function() {
        ...
        formatted = testedFormatter.format(entry);
        return formatted.should.equal('{ ' + '"timestamp": 0, ' + '"logger": "test", ' + '"level": "good", ' + '"message": "hello, file!", ' + '"author": "Maciej"' + ' }\n');
      });
      return it("formats an entry with meta", function() {
        ...
        formatted = testedFormatter.format(entry);
        return formatted.should.equal('{ ' + '"timestamp": 0, ' + '"logger": "test", ' + '"level": "good", ' + '"message": "hello, file!", ' + '"author": "Maciej", ' + '"»number": 1' + ' }\n');
      });
    });
  });
