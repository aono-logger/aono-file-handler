...
var FileHandler = /** @class */ (function () {
    function FileHandler(prefix, rotationBytesThreshold) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        this._currentFile = this.filePath(entries[0].timestamp);
                    ...
                    case 2:
                        ...
                        _b.label = 3;
                    case 3:
                        serializedEntries = entries.map(this.stringify).join('');
    ...
    FileHandler.prototype.filePath = function (timestamp) {
        return this.prefix + "." + format(new Date(timestamp));
    };
    FileHandler.prototype.stringify = function (entry) {
        return '{ ' +
