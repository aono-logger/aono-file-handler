...
(function() {
  var FileHandler, LogstashFormatter, fs, glob, util;
  ...
  describe("FileHandler", function() {
    ...
    describe("after creation", function() {
      ...
      return describe("when after handling log entry with meta", function() {
        ...
        it("contains properly set currentFileSize", function() {
          return testedHandler.currentFileSize.should.equal(124);
        });
        it("contains properly set bytesWritten", function() {
          return testedHandler.bytesWritten.should.equal(124);
        });
        return it("wrote log entry to a log file", function() {
          var contents;
          contents = fs.readFileSync(testedHandler.currentFile).toString("utf-8");
          return contents.should.equal('{ ' + '"timestamp": "1970-01-01T00:00:00.000Z", ' + '"logger": "test", ' + '"level": "good", ' + '"message": "hello, file!", ' + '"aono_number": 1' + ' }\n');
        });
      });
    });
    return describe("after creation with small rotation threshold", function() {
      ...
      smallThreshold = 16;
      beforeEach(function() {
        return testedHandler = new FileHandler(prefix, new LogstashFormatter, smallThreshold);
      });
